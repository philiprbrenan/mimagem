/*-----------------------------------------------------------------------------
LZMA compression and decompression in JavaScript
Philip R Brenan at gmail dot com, Appa Apps Ltd, 2019
------------------------------------------------------------------------------*/
const Tests         = 2;                                                        // Number of tests expected
const source        = "lzma";
...
function check()                                                                //P Test compression and decompression
 {const testStrings =
   [function ()
     {let a = "Hello World";
      return a;
  ...
  let tests = 0;
  for(const a of testStrings)                                                   // Try compressing and decompressing some strings
   {const b = compressLmza(a);
    const c = decompressLmza(JJJ(jjj(b)));
    assert(a === c); ++tests;
   }
...
module.exports = {                                                              // Exports
  compressLmza: compressLmza,
  decompressLmza: decompressLmza,
  lzma: lzma,
  rename: rename,
 }
...
function rename()                                                               // Create a rename string
 {return [
"  var compressLmza = Lzma.compressLmza;",
"  var decompressLmza = Lzma.decompressLmza;",
 ""].join("\n");
 }
